      ...
      <CardContent>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p>Henüz fikir yok</p>
            <p className="text-sm">Yeni bir fikir ekleyerek başlayın</p>
          </div>
        )}
      </CardContent>
...
function IdeaCard({ idea, creator, onMoveToCalendar, onEdit, onDelete, isMoving }: IdeaCardProps) {
  ...
  return (
    <div className="group relative bg-muted/50 rounded-lg p-3 border hover:border-primary/50 transition-colors">
      {/* Title */}
      <h4 className="font-medium text-sm line-clamp-2 pr-6">{idea.title}</h4>
